...
OBSTACLE_SCENARIOS = {
    ...
    # S1S2S5混合: 右侧+中间大障碍+左侧 -> 综合避障能力
    "s1_s2_s5_mixed": [
        Obstacle(20, -1.5, 1.0, "rect", 6.0, 2.0),   # S1: 右侧障碍 -> 左移
        Obstacle(50, 0.0, 1.3, "car", 6.0, 2.6),     # S5: 中间大障碍 -> 分流
        Obstacle(80, 1.5, 1.0, "rect", 6.0, 2.0),    # S2: 左侧障碍 -> 右移
    ],
